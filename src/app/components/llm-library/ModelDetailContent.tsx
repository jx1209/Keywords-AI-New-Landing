  ...
  return (
    <div className="flex flex-col items-center self-stretch">
      <div className="flex justify-center items-center gap-xxs self-stretch bg-primary-2 mt-[60px] w-full py-xxs">
        <span className="text-gray-white text-md">Not sure which model is right for you? Check out our latest blog:</span>
        <a href="https://www.keywordsai.co/blog/best-llms" className="text-gray-white text-md underline">The best LLMs for 2025</a>
      </div>
