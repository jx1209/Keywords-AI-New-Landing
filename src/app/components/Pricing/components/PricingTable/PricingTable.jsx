    ...
    free: {
      ...
      features: {
        Platform: {
          ...
          usage_based: {},
          analytics: {text: "100", hasCheck: true },
          prompt_management: {text: "2", hasCheck: true },
          ...
          log_ingestion: {text: "60 RPM", hasCheck: true },
          fine_tuning: {  },
          traces: {},
          sessions: {},
          evaluators: {},
    ...
    basic: {
      ...
      features: {
        Platform: {
          ...
          key_vault: { hasCheck: true },
          alerts: { hasCheck: true },
          log_ingestion: {text: "600 RPM", hasCheck: true },
          fine_tuning: {  },
          traces: { },
          sessions: {},
          evaluators: { },
    ...
    team: {
      ...
      features: {
        Platform: {
          ...
          key_vault: { hasCheck: true },
          alerts: { hasCheck: true },
          log_ingestion: {text: "6,000 RPM", hasCheck: true },
