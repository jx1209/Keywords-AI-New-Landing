    ...
    content: (
      <div className="Tos text-sm-regular text-gray-4">
        ...
        <p>
          ...
          ), a company registered in Delaware, United States.
        </p>
        <p>
        ...
        <p>
          ...
          team@keywordsai.co, or by mail to 406 Singleton Ave, Alameda, CA 94501,
          United States.
        </p>
        <p>
        ...
        <p>
          <strong>406 Singleton Ave</strong>
        </p>
        <p>
          <strong>Alameda, CA 94501</strong>
        </p>
        <p>
